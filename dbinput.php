...
<html lang="en">
  <head>
    ...
    <title>Anime Joy! | Database Input </title>
  </head>
  <body>
      <?php 
        include("one.php");
    ...
    <?php
        ...
        $URL = "https://anilist.co/api/browse/anime?sort=score-desc&access_token=$token";
        if($_GET["genre"] != null){
        ...
        try {
            ...
            /* $sql = "CREATE TABLE score (
                ...
                adult VARCHAR(11),
                average_score INT(11),
                popularity INT(11),
                image_url_sml VARCHAR(255),
                image_url_med VARCHAR(255),
                image_url_lge VARCHAR(255),
                reg_date TIMESTAMP
                )";
            ...
            echo "Table MyGuests created successfully"; */
                ...
                //     echo "<br>". $arr['title_english'];
                //     $conn->exec("INSERT INTO score (id, title_english, series_type, average_score, popularity, image_url_sml, image_url_med, image_url_lge) 
                //     VALUES (".$arr['id'].", '".str_replace('\'', '', $arr['title_english'])."', '".$arr['series_type']."', ".$arr['average_score'].", ".$arr['popularity'].", '".$arr['image_url_sml']."', '".$arr['image_url_med']."', '".$arr['image_url_lge']."')");
